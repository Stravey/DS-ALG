...
/*        Employee[] staff = new Employee[3];
        ...
        //C++中的vector是按值拷贝
        ArrayList<com.liu.OOP.Employee> staff = new ArrayList<com.liu.OOP.Employee>();
        //可以使用var关键字避免重复写类名
        //var staff = new ArrayList<Employee>();
        staff.add(0,new com.liu.OOP.Employee("张三",20000));
        staff.add(1,new com.liu.OOP.Employee("李四",30000));
        staff.add(2,new com.liu.OOP.Employee("王五",24000));
        for(Employee e : staff) {
